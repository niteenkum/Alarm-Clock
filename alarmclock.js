...
/* The code is used to set the alarm and for changing the currnt time */
setInterval(() => {
    var today = new Date();
...
function createCard(hour, minutes, seconds, ampm, status,index) {
  ...
  <div class="custom-card-for-alarm">
    ...
    <div class="alarm-delete d-flex justify-content-center">
        ...
        <img src="./Assests/trash-solid.svg" height="15px" onClick="deleteAlarmTile(${index})">
        </div>
    </div>
</div>`;
list.innerHTML += code;
...
/* This is a function that is used to create the cards that are used to display the alarm time. */
...
/* This is the code that is used to create the button that is used to add the alarm time. */
...
>
<img class="white-color-svg" src="./Assests/check-solid.svg" alt="" height="30px"/>
</button>
`;
let buttonForCancel = `
<button
...
>
<img class="white-color-svg" src="./Assests/times-solid.svg" alt="" height="30px"/>
</button>
`
...
onclick="addAlarm()"
>
<img class="white-color-svg" src="./Assests/plus-solid.svg" alt="" height="30px"/>
</button>`
